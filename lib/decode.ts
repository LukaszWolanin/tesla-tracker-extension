...
// ── Option Code Database (803 codes from GewoonJaap + verified overrides) ──

import { MARKET_OPTIONS } from './market-options';
export const OPTION_CODES: Record<string, string> = MARKET_OPTIONS;
